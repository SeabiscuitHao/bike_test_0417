<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"F:\www\practice_tp\think\public/../application/index\view\index\index.html";i:1507635479;s:76:"F:\www\practice_tp\think\public/../application/index\view\common\header.html";i:1507635345;s:75:"F:\www\practice_tp\think\public/../application/index\view\common\right.html";i:1507550084;s:74:"F:\www\practice_tp\think\public/../application/index\view\common\foot.html";i:1505394084;}*/ ?>
...
<div class="con">热门标签：
  ...
  <a href='http://localhost/practice_tp/think/public/index.php/index/search/index?keywords=<?php echo $vo['tagname']; ?>'><?php echo $vo['tagname']; ?></a>
  <?php endforeach; endif; else: echo "" ;endif; ?>
 </div>
</div>
	...
	<div class="left">
				<?php if(is_array($articleres) || $articleres instanceof \think\Collection || $articleres instanceof \think\Paginator): $i = 0; $__LIST__ = $articleres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					...
					<div class="pic"><a target="_blank" href="<?php echo url('article/index',array('arid' => $vo['id'])); ?>">
						<img src="
						<?php if($vo['pic'] != ''): ?>
						__IMG__<?php echo $vo['pic']; else: ?>
						__PUBLIC__/images/images.jpg
						<?php endif; ?>" alt="<?php echo $vo['title']; ?>"/></a></div>
					<div class="dec">
					...
					<div class="time">
						...
						foreach($arr as $k => $v){
							echo "<a href='http://localhost/practice_tp/think/public/index.php/index/search/index?keywords=$v'>$v</a>";
						}
						?> </div>
					</div>
					</div>
