<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"F:\www\practice_tp\think\public/../application/admin\view\article\edit.html";i:1506510956;s:73:"F:\www\practice_tp\think\public/../application/admin\view\common\top.html";i:1506518617;s:74:"F:\www\practice_tp\think\public/../application/admin\view\common\left.html";i:1506428340;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">文章作者</label>
														<div class="col-sm-6">
                                <input class="form-control" id="author" placeholder="" value="<?php echo $articles['author']; ?>" name="author" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">文章描述</label>
														<div class="col-sm-6">
															<textarea name="desc" class="form-control"><?php echo $articles['title']; ?></textarea>
                            </div>
                        </div>
												<div class="form-group">
                            ...
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">是否推荐</label>
														<div class="col-sm-6">
															<label>
																<input class="checkbox-slider colored-darkorange" <?php if($articles['state'] == 1): ?> checked="checked"<?php endif; ?> name="state" type="checkbox">
